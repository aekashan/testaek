<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectXMLExportPNG.aspx.cs" Inherits="WebApplication.SelectXMLExportPNG" %>
...
<script type="text/javascript" src="js/Export/html2canvas.js"></script>
    <script Language="javascript">
        ...
        $("#btnExcel").click(function () {
            $('#tbShow').tableExport({ type: 'png', escape: 'false' });
        });
